...
type Summary struct {
	...
	Quantile             []*Quantile `protobuf:"bytes,3,rep,name=quantile" json:"quantile"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
type Histogram struct {
	SampleCount          *uint64   `protobuf:"varint,1,opt,name=sample_count,json=sampleCount" json:"sample_count"`
	SampleSum            *float64  `protobuf:"fixed64,2,opt,name=sample_sum,json=sampleSum" json:"sample_sum"`
	Bucket               []*Bucket `protobuf:"bytes,3,rep,name=bucket" json:"bucket"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
type Metric struct {
	...
	Gauge                *Gauge       `protobuf:"bytes,2,opt,name=gauge" json:"gauge"`
	Counter              *Counter     `protobuf:"bytes,3,opt,name=counter" json:"counter"`
	Summary              *Summary     `protobuf:"bytes,4,opt,name=summary" json:"summary"`
	Untyped              *Untyped     `protobuf:"bytes,5,opt,name=untyped" json:"untyped"`
	Histogram            *Histogram   `protobuf:"bytes,7,opt,name=histogram" json:"histogram"`
...
type MetricFamily struct {
	...
	Metric               []*Metric   `protobuf:"bytes,4,rep,name=metric" json:"metric"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
